...
public class CM_ForceTransitionClose : MonoBehaviour {

	//Similar to AreaTransition, but staged differently to work with the CM toolkit. Part one: fades to black.
